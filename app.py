...
st.set_page_config(page_title="Tu Perfil de Inversionista", layout="centered")

st.title("📈 Tu Perfil de Inversionista Personalizado")
st.markdown("**Reporte Educativo** • Esto es contenido educativo y de entretenimiento. No es asesoramiento financiero. DYOR.")
